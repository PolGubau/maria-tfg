...
export const phases: Phase[] = [
	{
		...
		sections: [
			...
			},
			{
				...
				content: [
					"Aquí tens recursos específics per a familiars en fase de tractament. No has d'afrontar-ho sol.",
				],
				resources: [
					{
						name: "Línia d'ajuda AECC",
						description:
							"Atenció emocional gratuïta les 24 hores, tots els dies de l'any.",
						type: "helpline",
						phone: "900 100 036",
					},
					{
						...
						description:
							"Suport psicosocial i grups de familiars a la comarca del Maresme.",
						type: "association",
						website: "https://www.maresmen.cat",
					},
					{
						name: "Psicooncologia hospitalària",
						description:
							"L'hospital de referència pot facilitar accés al servei de psicooncologia. Demana'l als professionals sanitaris.",
						type: "service",
					},
					{
						name: "Grups de suport per a familiars",
						description:
							"Compartir l'experiència amb qui ho ha viscut és profundament terapèutic. Hi ha grups presencials i online.",
						type: "group",
					},
				],
			},
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				title: "Recursos i suport",
				content: [
					"El suport no s'acaba amb el tractament. Aquests recursos t'acompanyen en la nova normalitat.",
				],
				resources: [
					{
						name: "Línia d'ajuda AECC",
						description:
							"Disponible les 24 hores per a qualsevol dubte emocional o pràctic.",
						type: "helpline",
						phone: "900 100 036",
					},
					{
						name: "Grups de suport post-tractament",
						description:
							"Compartir l'experiència post-tractament amb altres familiars que l'han viscut és molt valuós.",
						type: "group",
					},
					{
						name: "Psicologia per a familiars",
						description:
							"Molts hospitals i associacions oncològiques ofereixen suport psicològic específic per a la fase post-tractament.",
						type: "service",
					},
					{
						name: "Apps i programes de mindfulness",
						description:
							"Recursos d'autoajuda guiada adaptats a la situació post-oncològica (Calm, Headspace, programes MBSR).",
						type: "app",
					},
				],
			},
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				title: "Recursos i suport",
				content: [
					"En aquesta fase, tenir accés ràpid al suport adequat és especialment important. No esperis a estar al límit.",
				],
				resources: [
					{
						name: "Línia d'ajuda AECC",
						description:
							"Suport emocional gratuït les 24 hores. Especialistes en acompanyament oncològic.",
						type: "helpline",
						phone: "900 100 036",
					},
					{
						name: "Equips de cures pal·liatives",
						description:
							"Disponibles a través de l'hospital i el CAP de referència. Treballen amb tota la família.",
						type: "service",
					},
					{
						name: "Psicologia en dol anticipat",
						description:
							"Associacions oncològiques de la teva zona ofereixen suport psicològic especialitzat en dol anticipat.",
						type: "service",
					},
					{
						name: "Grups de suport en fase avançada",
						description:
							"L'Associació Maresme Oncològic i la AECC disposen de grups específics per a familiars en aquesta etapa.",
						type: "group",
					},
				],
			},
